...
const bodyFont = Montserrat({ subsets: ["latin"], variable: "--font-body", weight: ["400", "500", "600", "700", "800"] });
const heroFont = Fredoka({ subsets: ["latin"], variable: "--font-hero", weight: ["600", "700"] });
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="it" className={`${bodyFont.variable} ${heroFont.variable}`}>
